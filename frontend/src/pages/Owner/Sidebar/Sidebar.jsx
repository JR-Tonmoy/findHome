...
const OwnerSidebar = ({ isOpen, setIsSidebarOpen }) => {
  ...
  const sideMenus = [
    ...
    {
      label: "My Properties",
      path: "/owner-dashboard/my-properties",
      ...
      >
        <div>
          ...
          <div className="p-6 border-b border-gray-200 flex justify-between items-center">
            ...
            <button
              className="md:hidden p-1 rounded-md bg-gray-100 hover:bg-gray-200 ml-2"
              onClick={() => setIsSidebarOpen(false)}
            >
              <X size={20} />
            </button>
          ...
          <div className="mx-4 mt-4 rounded-lg border border-emerald-200 bg-emerald-50 p-3">
            ...
            <div className="mt-3 inline-flex rounded-full bg-white px-2.5 py-1 text-[11px] font-semibold text-emerald-700 border border-emerald-300">
              🏠 Property Owner
            </div>
          </div>
